...
class GridNavItem {
  ...
  GridNavItem.fromJson(Map<String, dynamic> json){
    ...
    mainItem = json['mainItem'] != null ? new LocalNavListModel.fromJson(json['mainItem']) : null;
    item1 = json['item1'] != null ? new LocalNavListModel.fromJson(json['item1']) : null;
    item2 = json['item2'] != null ? new LocalNavListModel.fromJson(json['item2']) : null;
    item3 = json['item3'] != null ? new LocalNavListModel.fromJson(json['item3']) : null;
    item4 = json['item4'] != null ? new LocalNavListModel.fromJson(json['item4']) : null;
  }
